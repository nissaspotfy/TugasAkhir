...
import { ArrowLeft, Trash2, MapPin, Plus, CheckCircle2, ArrowRight, Home } from 'lucide-react';
...
export default function Checkout() {
  ...
  return (
    <div className="min-h-screen pb-20 font-sans bg-gray-50">
      ...
      <div className="max-w-4xl px-4 pt-36 mx-auto">
        <div className="mb-4">
          <Link 
            to="/" 
            className="inline-flex items-center justify-center w-10 h-10 rounded-full text-gray-500 hover:text-primary hover:bg-gray-100 transition-all -ml-2.5"
            title="Kembali ke Belanja"
          >
                        ...
                        <div className="p-6 bg-white border border-gray-100 shadow-sm rounded-2xl">
                                ...
                                <Button 
                                    ...
                                    onClick={() => {
                                        if (addresses.length >= 3) {
                                            alert("Maksimal 3 alamat yang dapat disimpan. Hapus alamat yang ada terlebih dahulu jika ingin menambahkan alamat baru.");
                                            return;
                                        }
                            ...
                            {addresses.length >= 3 && (
                                <p className="text-xs text-amber-600 font-bold mb-3 animate-pulse">
                                    ⚠️ Batas maksimum 3 alamat tersimpan telah tercapai.
                                </p>
                            )}
                                        ...
                                        >
                                            <div className="flex items-start justify-between">
                                                ...
                                                <div className="flex items-center gap-2 flex-shrink-0">
                                                    {addr.is_primary && <span className="px-2.5 py-1 text-xs text-blue-700 bg-blue-100 rounded-full font-bold">Utama</span>}
                                                    <button 
                                                        type="button"
                                                        onClick={(e) => {
                                                            e.stopPropagation();
